...
The R programming language is used widely throughout many academic fields;
tools in R for text mining are of particular importance because they
can be adopted by academics rapidly.
...
provide wild card search and some do not. Some sources are searching full text
...
Public Library of Science (PLoS)   | Full content/altmetrics | rplos                    | [^4]
...
CORE                               | Full content/Metadata   | rcoreoa                  | [^19]
...
conference proceedings, pre-prints, blog posts". Fatcat is currently does not have an
